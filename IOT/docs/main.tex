...
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/KrishnaYadati/Assignments/blob/main/IOT/codes/setup/src/main.cpp}}}
\end{center}
\begin{center}
\end{center}
\begin{lstlisting}
svn co https://github.com/KrishnaYadati/Assignments/trunk/IOT/codes/setup
cd  setup
pio run
pio run -t upload
\end{lstlisting}
...
\begin{center}
\fbox{\parbox{8cm}{\url{https://github.com/KrishnaYadati/Assignments/blob/main/IOT/codes/ota/src/main.cpp}}}
\end{center}
through 
\begin{lstlisting}
pio run 
